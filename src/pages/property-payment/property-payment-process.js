...
class PropertyPaymentProcess extends Component {
  constructor(props) {
    super(props);
    this.state = {
      orderList: [],
  ...
  queryOrderDetail=()=> {
    const parmas= storage.get('Property') || {};
    Post(API.queryPropertyDetail, parmas, true).then((res) => {
          ...
          <div className="process-bottom">
            <div className="process-buttom">
              <div className="cancle-order" onClick={this.Cancel.bind(this,item.payOrderNo)} >
                ...
                {item.showRepayBotton && <div className="confirm" onClick={this.confirm.bind(this, item.payOrderNo)}>
                  支付
               </div>}
            </div>
          </div>
...
PropertyPaymentProcess.propTypes = {
  nextPageStartDirection: PropTypes.func,
};

export default PropertyPaymentProcess;

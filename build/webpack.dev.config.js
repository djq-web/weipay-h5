...
module.exports = merge(commonConfig, {
  ...
  devServer: {
    ...
    proxy: {
      ...
      "/schoolpayment": {
        //target: "http://zhouyabing.dev.swiftpass.cn",        // 亚兵的IP
        //target: "http://paythough.test.swiftpass.cn",     //  旧测试环境
        // target: "https://wjf.swiftpass.cn/",                  //  线上环境
        target: "https://newpaythrough.test.swiftpass.cn/",
        // target: 'http://newpaythrough.dev.swiftpass.cn/',   // 开发环境
        // target :'http://192.168.20.93:9000/',//谢康本地
        pathRewrite: { "^/schoolpayment": "/schoolpayment" },
        changeOrigin: true,
        secure: false,
      },
    },
